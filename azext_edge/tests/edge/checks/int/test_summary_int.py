...
from azext_edge.edge.providers.edge_api import DATAFLOW_API_V1B1, DEVICEREGISTRY_API_V1, MQ_ACTIVE_API
...
def test_summary_checks():
    ...
    for api in ["Akri", MQ_ACTIVE_API, "OPCUA", DATAFLOW_API_V1B1, DEVICEREGISTRY_API_V1]:
