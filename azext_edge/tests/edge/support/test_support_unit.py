...
@pytest.mark.parametrize(
    ...
    [
        ...
        [MQTT_BROKER_API_V1, CLUSTER_CONFIG_API_V1, DEVICEREGISTRY_API_V1B1, NAMESPACED_DEVICEREGISTRY_API_V1],
        [MQTT_BROKER_API_V1, CLUSTER_CONFIG_API_V1, ARCCONTAINERSTORAGE_API_V1, NAMESPACED_DEVICEREGISTRY_API_V1],
