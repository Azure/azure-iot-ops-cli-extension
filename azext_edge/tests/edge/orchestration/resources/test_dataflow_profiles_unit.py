...
def get_dataflow_profile_endpoint(instance_name: str, resource_group_name: str, profile_name: Optional[str] = None):
...
def get_mock_dataflow_profile_record(profile_name: str, instance_name: str, resource_group_name: str):
