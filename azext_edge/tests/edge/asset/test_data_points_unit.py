...
@pytest.mark.parametrize("show_asset_fixture", [MINIMUM_ASSET, FULL_ASSET], indirect=True)
@pytest.mark.parametrize("resource_group_name", [None, generate_generic_id()])
def test_list_asset_data_points(fixture_cmd, show_asset_fixture, resource_group_name):
    asset_name = generate_generic_id()
...
def test_remove_asset_data_point(
    fixture_cmd, embedded_cli_client, show_asset_fixture, resource_group_name, data_source, name
):
    asset_name = generate_generic_id()
...
@pytest.mark.parametrize("resource_group_name", [None, generate_generic_id()])
def test_remove_asset_data_point_error(fixture_cmd, resource_group_name):
    asset_name = generate_generic_id()
