...
def create_namespace_custom_asset(
    ...
    datasets_destinations: Optional[str] = None,
    ...
    streams_destinations: Optional[str] = None,
    ...
    **kwargs
    ...
    return NamespaceAssets(cmd).create(
        ...
        streams_destinations=streams_destinations,
...
def create_namespace_opcua_asset(
    ...
    events_filter_clauses: Optional[List[List[str]]] = None,  # key=value pairs of path (req), type, field
    events_destinations: Optional[str] = None,
    description: Optional[str] = None,
    disabled: Optional[bool] = None,
    display_name: Optional[str] = None,
    ...
    **kwargs
    ...
    return NamespaceAssets(cmd).create(
        ...
        asset_type_refs=asset_type_refs,
        attributes=attributes,
        dataset_publishing_interval=dataset_publishing_interval,
        dataset_sampling_interval=dataset_sampling_interval,
        dataset_queue_size=dataset_queue_size,
        dataset_key_frame_count=dataset_key_frame_count,
        dataset_start_instance=dataset_start_instance,
        datasets_destinations=datasets_destinations,
        events_publishing_interval=events_publishing_interval,
        events_queue_size=events_queue_size,
        events_start_instance=events_start_instance,
        events_filter_type=events_filter_type,
        events_filter_clauses=events_filter_clauses,
        events_destinations=events_destinations,
        description=description,
        disabled=disabled,
        display_name=display_name,
