...
def create_namespace_opcua_asset(
    ...
    **kwargs
    ...
    return NamespaceAssets(cmd).create(
        ...
        datasets_destinations=datasets_destinations,
        opcua_events_publishing_interval=events_publishing_interval,
        opcua_events_queue_size=events_queue_size,
        opcua_events_start_instance=events_start_instance,
        opcua_events_filter_type=events_filter_type,
        opcua_events_filter_clauses=events_filter_clauses,
        events_destinations=events_destinations,
        description=description,
        disabled=disabled,
        display_name=display_name,
