...
class EventGridManagementClient:
    ...
    :vartype client_groups: eventgrid.mgmt.operations.ClientGroupsOperations
    :ivar namespaces: NamespacesOperations operations
    :vartype namespaces: eventgrid.mgmt.operations.NamespacesOperations
    :ivar permission_bindings: PermissionBindingsOperations operations
    :vartype permission_bindings: eventgrid.mgmt.operations.PermissionBindingsOperations
    :ivar topic_spaces: TopicSpacesOperations operations
    :vartype topic_spaces: eventgrid.mgmt.operations.TopicSpacesOperations
