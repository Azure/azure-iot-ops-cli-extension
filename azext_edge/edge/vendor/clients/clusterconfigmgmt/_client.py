...
from ._configuration import KubernetesConfigurationClientConfiguration
...
class KubernetesConfigurationClient:
    ...
    :vartype extensions: k8sconfig.mgmt.operations.ExtensionsOperations
    :ivar operation_status: OperationStatusOperations operations
    :vartype operation_status: k8sconfig.mgmt.operations.OperationStatusOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = KubernetesConfigurationClientConfiguration(
    ...
    def __enter__(self) -> "KubernetesConfigurationClient":
