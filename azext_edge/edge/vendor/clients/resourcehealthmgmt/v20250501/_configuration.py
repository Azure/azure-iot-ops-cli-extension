...
class MicrosoftResourceHealthConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    ...
    def __init__(self, credential: "TokenCredential", subscription_id: str, **kwargs: Any) -> None:
        ...
        kwargs.setdefault("sdk_moniker", "resourcehealth/{}".format(VERSION))
