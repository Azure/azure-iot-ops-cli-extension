...
class CustomLocationsConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, subscription_id: str, credential: "TokenCredential", **kwargs: Any) -> None:
        ...
        kwargs.setdefault("sdk_moniker", "extendedlocation/{}".format(VERSION))
