...
class MicrosoftDeviceRegistryManagementService:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype namespace_devices: azure.mgmt.deviceregistry.operations.NamespaceDevicesOperations
    :ivar namespace_discovered_assets: NamespaceDiscoveredAssetsOperations operations
    :vartype namespace_discovered_assets:
     azure.mgmt.deviceregistry.operations.NamespaceDiscoveredAssetsOperations
    :ivar namespace_discovered_devices: NamespaceDiscoveredDevicesOperations operations
    :vartype namespace_discovered_devices:
     azure.mgmt.deviceregistry.operations.NamespaceDiscoveredDevicesOperations
