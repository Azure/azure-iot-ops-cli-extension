    ...
    helps[
        ...
        - name: Create an asset using the given cluster name and custom location.
          text: >
            ...
            --custom-location {custom_location} --endpoint {endpoint} --data data_source={data_source}
        ...
        - name: Create an asset with custom asset type, description, documentation uri, external asset id, hardware revision,
          ...
          text: >
            ...
            --product-code {product_code} --software-revision {software_revision} --event event_notifier={event_notifier}
