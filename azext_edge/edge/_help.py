...
def load_iotops_help():
    ...
    helps[
        ...
        - name: Show details of target schema version 1.
          text: >
            az iot ops schema version show -v 1 --schema myschema --registry myregistry -g myresourcegroup
    """
    ...
    helps[
        ...
        - name: Remove schema version 1.
          text: >
            az iot ops schema version remove -v 1 -g myresourcegroup --registry myregistry --schema myschema
    """
    ...
    helps[
        ...
        - name: Add a schema version 1 to a schema called 'myschema' within the registry 'myregistry' with
          ...
          text: >
            az iot ops schema version add -v 1 -g myresourcegroup --registry myregistry --schema myschema --content '{\\\"hello\\\": \\\"world\\\"}'
        - name: Add a schema version 1 to a schema called 'myschema' within the registry 'myregistry' with
        ...
        - name: Add a schema version 2 to a schema called 'myschema' within the registry 'myregistry' with
          ...
          text: >
            az iot ops schema version add -v 2 -g myresourcegroup --registry myregistry --schema myschema --content myschemav2.json --desc "New schema"
    """
