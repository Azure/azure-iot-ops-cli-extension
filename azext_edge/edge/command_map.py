...
def load_iotops_commands(self, _):
    ...
    with self.command_group(
        ...
        cmd_group.command("create", "create_broker_listener")
    ...
    with self.command_group(
        ...
        cmd_group.command("create", "create_broker_authn")
    ...
    with self.command_group(
        ...
        cmd_group.command("create", "create_broker_authz")
    ...
    with self.command_group(
        ...
        cmd_group.command("import", "import_dataflow_endpoint")
    ...
    with self.command_group(
        ...
        cmd_group.command("localstorage", "update_dataflow_endpoint_localstorage")
