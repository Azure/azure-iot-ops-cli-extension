...
MONIKER = "extensioneventscollector"
COMPONENT_LABEL = "app.kubernetes.io/component in (extension-events-collector)"
...
def fetch_services():
    return  process_services(moniker=MONIKER, label_selector="app.kubernetes.io/managed-by in (Helm)", prefix_names=["extension-events-collector"])
