...
TEMPLATE_BLUEPRINT_ENABLEMENT = TemplateBlueprint(
    commit_id="fe8c8fa92777eb2474f0597beaf5f21f165bb7a2",
    content={
        "$schema": "https://schema.management.azure.com/schemas/2019-04-01/deploymentTemplate.json#",
        "languageVersion": "2.0",
        "contentVersion": "1.0.0.0",
        "metadata": {
            "_generator": {"name": "bicep", "version": "0.36.177.2456", "templateHash": "2911227071796372649"}
        },
        "definitions": {
            "_1.AdvancedConfig": {
                "type": "object",
...
TEMPLATE_BLUEPRINT_INSTANCE = TemplateBlueprint(
    ...
    content={
        ...
        "contentVersion": "1.0.0.0",
        "metadata": {
            "_generator": {"name": "bicep", "version": "0.36.177.2456", "templateHash": "13958672862330490670"}
        },
        "definitions": {
            "_1.AdvancedConfig": {
                "type": "object",
