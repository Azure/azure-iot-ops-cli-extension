...
V1_TEMPLATE = TemplateVer(
    ...
    content={
        ...
        "metadata": {
            "_generator": {"name": "bicep", "version": "0.28.1.47646", "templateHash": "18271314775173870285"},
        ...
        "variables": {
            ...
            "VERSIONS": {
                ...
                "aio": "0.6.0-preview-rc20240712.2",
            ...
            },
            {
                ...
                "properties": {
                    ...
                    "configurationSettings": {
                        ...
                        "adr.enabled": "true",
                        "adr.image.registry": "mcr.microsoft.com",
                        "adr.image.repository": "azureiotoperations/helm/adr/assets-arc-extension",
                        "adr.image.tag": "0.1.0-preview",
                        "akri.enabled": "true",
                        "akri.image.registry": "azureiotoperations.azurecr.io",
