    ...
    content={
        ...
        "variables": {
            ...
            "defaultAioConfigurationSettings": {
                ...
                "akri.values.agent.extensionService.mqttBroker.hostName": "aio-broker.azure-iot-operations",
                "akri.values.agent.extensionService.mqttBroker.port": "18883",
                "akri.values.agent.extensionService.mqttBroker.serviceAccountAudience": "aio-internal",
                "akri.values.agent.host.containerRuntimeSocket": "",
                "akri.values.kubernetesDistro": "k8s",
                ...
                "observability.metrics.exportIntervalSeconds": "60",
