...
MGMT_ACTIONS_EG_AUDIENCE = "https://eventgrid.azure.net/"
...
MGMT_ACTIONS_GRAPH_ARTIFACT = "graph-dataflow-map:0.1.0"
MGMT_ACTIONS_GRAPH_RULES_VERSION = "0.1.0"
MIN_EG_CLIENT_SESSIONS_PER_AUTH_NAME = 2
