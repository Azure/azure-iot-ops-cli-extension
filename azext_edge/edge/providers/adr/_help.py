...
def load_iotops_adr_help():
    ...
    helps[
        ...
        examples:
        - name: Migrate assets by resource Id to a namespace.
          text: >
            az iot ops asset migrate --name myInstance --resource-group myresourcegroup
            --resource-ids $ASSET_1_RESOURCE_ID $ASSET_2_RESOURCE_ID $ASSET_3_RESOURCE_ID
    """
