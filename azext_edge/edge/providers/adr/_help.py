...
def load_iotops_adr_help():
    ...
    helps[
        ...
        - name: Add a custom endpoint with authentication
          text: >
            az iot ops ns device endpoint inbound add custom --device mydevice --instance myInstance -g myInstanceResourceGroup --name myCustomEndpoint --endpoint-type "Custom.Type" --endpoint-address "192.168.1.100:8080" --user-ref usernameSecret --user-ref passwordSecret
    ...
    helps[
        ...
        - name: Add a media endpoint with authentication
          text: >
            az iot ops ns device endpoint inbound add media --device mydevice --instance myInstance -g myInstanceResourceGroup --name myCameraEndpoint --endpoint-address "rtsp://192.168.1.100:554/stream" --user-ref usernameSecret --user-ref passwordSecret
    """
    ...
    helps[
        ...
        - name: Add an ONVIF endpoint with authentication
          text: >
            az iot ops ns device endpoint inbound add onvif --device mydevice --instance myInstance -g myInstanceResourceGroup --name myONVIFEndpoint --endpoint-address "http://192.168.1.100:8000/onvif/device_service" --user-ref usernameSecret --user-ref passwordSecret
    ...
    helps[
        ...
        - name: Add an OPC UA endpoint with authentication
          text: >
            az iot ops ns device endpoint inbound add opcua --device mydevice --instance myInstance -g myInstanceResourceGroup --name myOPCUAEndpoint --endpoint-address "opc.tcp://192.168.1.100:4840" --user-ref usernameSecret --user-ref passwordSecret
