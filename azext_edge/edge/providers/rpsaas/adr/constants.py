...
CUSTOM_LOCATION_NOT_FOUND_ERROR = "Custom location {0} not found. The command may fail."
CLUSTER_NOT_FOUND_ERROR = "Cluster associated with the custom location {0} not found. "\
    "The command may fail."
CLUSTER_OFFLINE = "Cluster {0} is not connected. The cluster may not update correctly."
